...
The following pairs plot displays the population structure after removing outliers across the first 4 principal components for `r params$Sample` based on refernce populations from 1000 genomes.
