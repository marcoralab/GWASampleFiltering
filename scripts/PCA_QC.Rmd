...
Individuals of non-`r sp_labs[params$superpop]` ancestry were identified by determining the mean and standard deviation of the 10 principal components scores for the `r params$superpop` super-population (Table 1). Participants in `r params$Sample` who were \pm 6 SD from the `r params$superpop` population mean were determined to be of non-`r sp_labs[params$superpop]` ancestry (Tab. \@ref(tab:pcastats)).
