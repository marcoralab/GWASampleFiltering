...
rel_tab_filt[rel_tab_filt$relationship == 'half-siblings', ]$relationship <- "first-degree relative"
rel_tab_filt[rel_tab_filt$relationship == 'first-cousin', ]$relationship <- "second-degree relative"
