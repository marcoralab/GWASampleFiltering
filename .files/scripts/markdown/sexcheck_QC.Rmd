...
output:
  html_document:
    df_print: paged
params:
  path.sex.file: '~/Dropbox/Research/PostDoc/MitoWax/2_Derived_Data/GWAS_pres_processing/ADNI_1/ADNI1_sex_discordance.sexcheck'
editor_options:
...
sexcheck.raw <- read_table(params$path.sex.file)
