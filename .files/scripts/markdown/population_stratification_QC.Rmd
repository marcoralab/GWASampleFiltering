...
##---- Read in Data ----##
# PCA file from plink
pca.raw <- read_delim(params$path.ps.eigenvec, delim = " ", col_names = F)

# egien values
eigenval.raw <- read_table(params$path.ps.eigenval, col_names = F)
...
### Population substructure
The following plots show the population structure of `r params$cohort` ( based on the first two (Fig. 4) and three (Fig. 5) principal components compared with the reference populations from 1000 Genomes.
