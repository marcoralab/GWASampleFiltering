...
params:
  ...
  path.out.file: Users/sheaandrews/Dropbox/Research/PostDoc/MitoWax/2_Derived_Data/GWAS_pres_processing/ADNI_1/exclude_relatdness_adni1.txt
  cohort: ADNI
editor_options:
...
dat.inter <- as.tibble(read.table(params$path.genome.file, header = TRUE, check.names = FALSE, as.is = TRUE))

##  Read in PLINK .fam file
fam <- read_delim(params$path.fam.file, delim = " ", col_names = F)
```
