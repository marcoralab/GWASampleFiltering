...
if (snakemake@params[["Family"]] == "F" ||
    snakemake@params[["Family"]] == FALSE) {
  dat_forplots %>%
...
To construct a sample of unrelated individuals, participants with the highest number of proportions of IBD sharing > `r snakemake@params[["pi_threshold"]]` were iteratively removed.
