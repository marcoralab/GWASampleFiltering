...
#load("output/ADGC/x_present_AA/ADC8-AA_pca.Rdata" %>% here)
...
```{r ternplots assign, echo=F, fig.width=7.5, fig.height=3.4, fig.align='center', fig.cap='Ancestry assignment viewed on PCs 1-3'}
